...
void train_prog(char *cfg, char *weight, char *acfg, char *aweight, int clear, int display, const char *train_images, int maxbatch)
{
#ifdef GPU
    char *backup_directory = "/home/pjreddie/backup/";
    srand(time(0));
...
void train_dcgan(char *cfg, char *weight, char *acfg, char *aweight, int clear, int display, const char *train_images, int maxbatch)
{
#ifdef GPU
    char *backup_directory = "/home/pjreddie/backup/";
    srand(time(0));
...
void run_lsd(int argc, char **argv)
{
    ...
    const char *file = find_char_arg(argc, argv, "-file", "/home/pjreddie/data/imagenet/imagenet1k.train.list");
