...
void resize_normalization_layer(layer *layer, int w, int h)
{
    ...
    layer->inputs = w*h*c;
    layer->outputs = layer->inputs;
    layer->output = (float *)realloc((void *)layer->output, h * w * c * batch * sizeof(float));
    layer->delta = (float *)realloc((void *)layer->delta, h * w * c * batch * sizeof(float));
    layer->squared = (float *)realloc((void *)layer->squared, h * w * c * batch * sizeof(float));
    layer->norms = (float *)realloc((void *)layer->norms, h * w * c * batch * sizeof(float));
#ifdef GPU
